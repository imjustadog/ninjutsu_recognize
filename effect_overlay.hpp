...
class effect_overlay
{
  private:
    ...
    string current_seq = "";
    unordered_map<string, int(effect_overlay::*)(cv::Mat,cv::Point,int)> seq_map{{"r60", &effect_overlay::draw_lightning}, {"24bgiokr2", &effect_overlay::draw_water}, {"q9qzqn3q", &effect_overlay::draw_lightning}, {"w", &effect_overlay::draw_lightning}};
  public:
    effect_overlay();
    ~effect_overlay();
